  ...
  return (
    <div>
      <PageHeader
        ...
        actions={
          /* Pastiglia sul livello VETRO: una riga sola, nella testata, sopra il campo luminoso. */
          <span className="glass-chrome inline-flex h-11 items-center gap-2 rounded-full px-4 text-[13px] font-semibold text-white">
      ...
      {/* ---------- Fascia 1 — Dove sei adesso: ferro, nessun bagliore ---------- */}
      ...
      {/* ---------- Fascia 2 — I piani: cascata interna, un solo faro ---------- */}
